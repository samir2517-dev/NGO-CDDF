...
<section class="py-5" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
    <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            ">
                Meet Our <span style="color: #0D47A1;">Team</span>
            </h1>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                ...
                " onmouseover="this.style.transform='translateY(-15px)'; this.style.boxShadow='0 15px 40px rgba(13, 71, 161, 0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 5px 20px rgba(0,0,0,0.08)';">
                    ...
                    ">
                        @if($member->photo)
                        <img src="{{ asset('images/team_members/'.$member->photo) }}" alt="{{ $member->name }}" style="
                            width: 100%;
                            height: 100%;
                            object-fit: cover;
                    ...
                    <div style="padding: 25px 20px;">
                        ...
                        <p style="
                            ...
                            font-size: 15px;
                            font-weight: 600;
                            margin-bottom: {{ $member->department ? '5px' : '15px' }};
        ...
        <div class="text-center py-5" data-aos="fade-up">
            ...
            <h4 style="color: #6c757d; font-weight: 600;">No Team Members Yet</h4>
            <p style="color: #adb5bd;">Team members will appear here once added.</p>
        </div>
        @endif
    </div>
</section>
