...
<section class="py-5" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
    <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            ">
                Origin & <span style="color: #0D47A1;">Legal Affiliation</span>
            </h1>
        ...
        <div class="row g-4">
            @foreach($affilation as $index => $data)
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                ...
                " onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 40px rgba(13, 71, 161, 0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 5px 20px rgba(0,0,0,0.08)';">
                    ...
                    <div style="
                        ...
                        z-index: 1;
                    ">
                        <i class="icon-award" style="font-size: 45px; color: white;"></i>
                    </div>
                    ...
                    <!-- Download Button -->
                    <a href="{{ asset('images/legal_affilation/'.$data->file) }}" target="_blank" style="
                        display: inline-flex;
                        align-items: center;
                        gap: 12px;
                        padding: 14px 35px;
                    ...
                    <div style="
                        ...
                        z-index: 1;
                    ">
                        <i class="icon-doc" style="margin-right: 5px;"></i>
                        PDF Document
                    </div>
                </div>
            </div>
        ...
        <div class="text-center py-5" data-aos="fade-up">
            <i class="icon-folder" style="font-size: 80px; color: #dee2e6; margin-bottom: 20px;"></i>
            <h4 style="color: #6c757d; font-weight: 600;">No Certificates Available</h4>
            <p style="color: #adb5bd;">Legal affiliation documents will appear here once added.</p>
        </div>
        @endif
        ...
        <div class="row mt-5">
            <div class="col-12" data-aos="fade-up" data-aos-delay="300">
                ...
                ">
                    <i class="icon-info" style="font-size: 40px; margin-bottom: 15px; opacity: 0.9;"></i>
                    <p style="
                        font-size: 17px;
                        margin: 0;
                        line-height: 1.8;
                        opacity: 0.95;
                    ">
                        All certificates are official legal documents. Click the download button to view or save the PDF files.
                    </p>
                </div>
            </div>
        </div>
