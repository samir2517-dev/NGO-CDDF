                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <a href="{{ route('executive.edit',$item->id) }}" class="btn btn-outline-primary btn-sm me-1" title="Edit">
                                        <i class="mdi mdi-pencil"></i>
                                    </a>
                                    <a href="{{ route('executive.delete',$item->id) }}" class="btn btn-outline-danger btn-sm delete-confirm" title="Delete">
