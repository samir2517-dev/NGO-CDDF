...
<div class="row">
    <div class="col-xl-9 mx-auto">
        <h6 class="mb-0 text-uppercase">Edit Volunteer Opportunity</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('volunteers.update',$data->id) }}" method="post">
                        @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="description" name="description" class="form-control summernote @error('description') is-invalid @enderror" rows="5">{{ $data->description }}</textarea>
                            @error('description')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
