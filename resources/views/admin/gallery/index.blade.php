                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <a href="{{ route('gallery.edit',$gallery->id) }}" class="btn btn-outline-primary btn-sm me-1" title="Edit">
                                        <i class="mdi mdi-pencil"></i>
                                    </a>
                                    <a href="{{ route('gallery.delete',$gallery->id) }}" class="btn btn-outline-danger btn-sm delete-confirm" title="Delete">
