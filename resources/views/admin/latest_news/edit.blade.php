                ...
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('news.update',$news->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <span class="text-info">Leave empty to keep the current cover image. Image Dimension Must be (725 X 375) and maximum size 10 MB.</span>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row g-2" id="gallery-container">
                                @foreach(json_decode($news->gallery_images) as $index => $galleryImage)
                                <div class="col-md-2 gallery-item" data-image="{{ $galleryImage }}" draggable="true">
                                    <div class="position-relative" style="cursor: move;">
                                        ...
                                        <img src="{{ asset('images/news/gallery/'.$galleryImage) }}" alt="" class="img-thumbnail">
